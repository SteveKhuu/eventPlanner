...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Task.is_managing'
        db.delete_column('eventPlanner_task', 'is_managing')

        # Adding field 'Task.complete'
        db.add_column('eventPlanner_task', 'complete',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Task.is_managing'
        db.add_column('eventPlanner_task', 'is_managing',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Task.complete'
        db.delete_column('eventPlanner_task', 'complete')
    ...
    models = {
        ...
        'eventPlanner.events': {
            ...
            'attendees': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['auth.User']", 'through': "orm['eventPlanner.Attendee']", 'symmetrical': 'False'}),
