...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Attendee.first_name'
        db.delete_column('eventPlanner_attendee', 'first_name')

        # Deleting field 'Attendee.last_name'
        db.delete_column('eventPlanner_attendee', 'last_name')


    def backwards(self, orm):
        # Adding field 'Attendee.first_name'
        db.add_column('eventPlanner_attendee', 'first_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Attendee.last_name'
        db.add_column('eventPlanner_attendee', 'last_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)
